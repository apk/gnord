...
var cgiroot = flag.String("cgipath", "", "cgi root directory")
...
func main() {
	...
	mux.HandleFunc("/", gnord.GnordHandleFunc(&gnord.GnordOpts{Path: pth, IpHeader: *iphead, CgiPath: cgi}))
